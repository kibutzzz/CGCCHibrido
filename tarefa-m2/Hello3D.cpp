...
GLuint setupGeometry()
{
    ...
    GLfloat vertices[] = {
        V(-0.5f, -0.5f,  0.5f, RED),   V( 0.5f, -0.5f,  0.5f, RED),   V( 0.5f,  0.5f,  0.5f, RED),
        V( 0.5f,  0.5f,  0.5f, RED),   V(-0.5f,  0.5f,  0.5f, RED),   V(-0.5f, -0.5f,  0.5f, RED),

        V( 0.5f, -0.5f, -0.5f, GREEN), V(-0.5f, -0.5f, -0.5f, GREEN), V(-0.5f,  0.5f, -0.5f, GREEN),
        V(-0.5f,  0.5f, -0.5f, GREEN), V( 0.5f,  0.5f, -0.5f, GREEN), V( 0.5f, -0.5f, -0.5f, GREEN),

        V(-0.5f, -0.5f, -0.5f, BLUE),  V(-0.5f, -0.5f,  0.5f, BLUE),  V(-0.5f,  0.5f,  0.5f, BLUE),
        V(-0.5f,  0.5f,  0.5f, BLUE),  V(-0.5f,  0.5f, -0.5f, BLUE),  V(-0.5f, -0.5f, -0.5f, BLUE),

        V( 0.5f, -0.5f,  0.5f, YELLOW),V( 0.5f, -0.5f, -0.5f, YELLOW),V( 0.5f,  0.5f, -0.5f, YELLOW),
        V( 0.5f,  0.5f, -0.5f, YELLOW),V( 0.5f,  0.5f,  0.5f, YELLOW),V( 0.5f, -0.5f,  0.5f, YELLOW),

        V(-0.5f,  0.5f,  0.5f, CYAN),  V( 0.5f,  0.5f,  0.5f, CYAN),  V( 0.5f,  0.5f, -0.5f, CYAN),
        V( 0.5f,  0.5f, -0.5f, CYAN),  V(-0.5f,  0.5f, -0.5f, CYAN),  V(-0.5f,  0.5f,  0.5f, CYAN),

        V(-0.5f, -0.5f, -0.5f, MAGENTA),V( 0.5f, -0.5f, -0.5f, MAGENTA),V( 0.5f, -0.5f,  0.5f, MAGENTA),
        V( 0.5f, -0.5f,  0.5f, MAGENTA),V(-0.5f, -0.5f,  0.5f, MAGENTA),V(-0.5f, -0.5f, -0.5f, MAGENTA),
    };
