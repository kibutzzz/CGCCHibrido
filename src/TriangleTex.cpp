...
void drawTriangle(GLuint shaderID, GLuint VAO, vec3 position, vec3 dimensions,
                  float angle, vec3 color, vec3 axis = (vec3(0.0, 0.0, 1.0)));
...
// Essencial para computadores da Apple
  ...
  GLFWwindow* window = glfwCreateWindow(
      WIDTH, HEIGHT, "Ola Triangulo Texturizado!", nullptr, nullptr);
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // Primeiro Triângulo
    drawTriangle(shaderID, VAO, vec3(100.0, 500.0, 0.0),
                 vec3(100.0, 100.0, 1.0), 0.0, vec3(0.0, 0.0, 1.0));

    // Segundo Triângulo
    drawTriangle(shaderID, VAO, vec3(350.0, 300.0, 0.0),
                 vec3(200.0, 200.0, 1.0), 180.0, vec3(0.0, 1.0, 0.0));

    // Terceiro Triângulo
    drawTriangle(shaderID, VAO, vec3(600.0, 200.0, 0.0),
                 vec3(300.0, 300.0, 1.0), 0.0, vec3(1.0, 0.0, 0.0));
...
void drawTriangle(GLuint shaderID, GLuint VAO, vec3 position, vec3 dimensions,
                  float angle, vec3 color, vec3 axis) {
  // Matriz de modelo: transformações na geometria (objeto)
  mat4 model = mat4(1);  // matriz identidade
  // Translação
